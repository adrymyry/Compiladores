...
union YYSTYPE
{
#line 13 "sintactico.y" /* yacc.c:355  */

    int entero;
    char *cadena;

#line 152 "sintactico.tab.c" /* yacc.c:355  */
};
...
{
  "$end", "error", "$undefined", "PROGRAMA", "VAR", "ENTERO", "COMIENZO",
  "FIN", "SI", "ENTONCES", "SINO", "MIENTRAS", "HACER", "IMPRIMIR", "LEER",
  "PYC", "DOSP", "PUNTO", "COMA", "MAS", "MENOS", "MULT", "PARI", "PARD",
  "DIV", "ASSIGN", "NUM", "ID", "CADENA", "UMENOS", "$accept", "program",
  "declarations", "identifier_list", "type", "compound_statement",
  "optional_statements", "statement_list", "statement", "print_list",
...
{
       4,   -11,     8,     0,   -38,     5,    16,   -38,    11,    10,
      12,    15,   -38,     3,   -16,   -16,    34,    17,     2,   -38,
      39,    23,   -38,   -38,    42,    22,   -16,   -16,   -38,   -38,
      21,    31,   -38,    30,   -38,    50,   -38,    35,   -16,   -38,
      12,   -38,    43,   -38,   -38,    44,    12,   -16,   -16,   -16,
     -16,    12,    34,    32,    50,   -38,   -38,   -38,    47,   -19,
     -19,   -38,   -38,   -38,   -38,   -38,    12,   -38
};
...
{
       0,     0,     0,     0,     1,     0,     0,     4,     0,     0,
      10,     0,     5,     0,     0,     0,     0,     0,     0,    14,
       0,     9,    11,     2,     0,     0,     0,     0,    33,    32,
       0,     0,    23,    18,    20,    22,    24,    19,     0,     8,
       0,     7,     0,     6,    30,     0,     0,     0,     0,     0,
       0,     0,     0,     0,    13,    12,     3,    31,    16,    26,
      27,    28,    29,    17,    21,    25,     0,    15
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -38,   -38,   -38,   -38,   -38,    58,   -38,   -38,   -37,   -38,
      20,   -38,   -14
};
...
{
      30,    31,    49,    55,    26,    50,    27,     1,     4,    58,
      28,    29,    44,    45,    63,     9,     3,    10,    10,    24,
      14,    25,     5,    15,    54,    16,    17,    38,     6,    67,
      46,     7,    23,    59,    60,    61,    62,    12,    40,    18,
      47,    48,    49,    51,    36,    50,    39,    41,    52,    43,
      47,    48,    49,    53,    26,    50,    27,    66,    56,    65,
      28,    29,    32,    47,    48,    49,    11,    57,    50,    47,
      48,    49,    64,     0,    50
};

static const yytype_int8 yycheck[] =
{
      14,    15,    21,    40,    20,    24,    22,     3,     0,    46,
      26,    27,    26,    27,    51,     4,    27,     6,     6,    16,
       8,    18,    22,    11,    38,    13,    14,    25,    23,    66,
       9,    15,    17,    47,    48,    49,    50,    27,    15,    27,
      19,    20,    21,    12,    27,    24,     7,     5,    18,    27,
      19,    20,    21,    18,    20,    24,    22,    10,    15,    27,
      26,    27,    28,    19,    20,    21,     8,    23,    24,    19,
      20,    21,    52,    -1,    24
};
...
{
       0,     3,    31,    27,     0,    22,    23,    15,    32,     4,
       6,    35,    27,    33,     8,    11,    13,    14,    27,    35,
      36,    37,    38,    17,    16,    18,    20,    22,    26,    27,
      42,    42,    28,    39,    40,    42,    27,    41,    25,     7,
      15,     5,    34,    27,    42,    42,     9,    19,    20,    21,
      24,    12,    18,    18,    42,    38,    15,    23,    38,    42,
      42,    42,    42,    38,    40,    27,    10,    38
};
...
#line 1295 "sintactico.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 49 "sintactico.y" /* yacc.c:1646  */
    {
                                printf("declarations -> lambda\n");
                            }
#line 1303 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 1327 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 1383 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 1455 "sintactico.tab.c" /* yacc.c:1646  */
    break;
